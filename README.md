...
**Описание на:**
- [🌐 English Version](https://github.com/Sshadow84/aztec-monitoring-script/blob/main/en/ "English version of description")
...
- Полная локализация, включая скрипт и уведомления в телеграм, на три языка. 
...
Если вышло обновление для cron-агента, сначала обновите весь скрипт. После удалите старого агента и создайте нового.
...
[Скрипт для запуска RPC в один клик](https://github.com/Sshadow84/sepolia-auto-install "Запуск Sepolia узла для RPC")
