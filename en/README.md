...
**Description in:**
- [🇷🇺 Russian Version](https://github.com/Sshadow84/aztec-monitoring-script/blob/main/ "Русская версия описания")

![Bash](https://img.shields.io/badge/Bash-5.2-blue)
![Docker](https://img.shields.io/badge/Docker-20.10+-blue)
![Telegram](https://img.shields.io/badge/Telegram-API-blue)

![Main Screen](https://raw.githubusercontent.com/Sshadow84/aztec-monitoring-script/main/other/img-en-2025-05-25-05-44-01.png)
...
| 🌐 **Languages** | Language support English/Russian                  |
...
2. **Launch or Update**:
   ...
   ```bash
   curl -o aztec-logs.sh https://raw.githubusercontent.com/Sshadow84/aztec-monitoring-script/main/aztec-logs.sh && chmod +x aztec-logs.sh && ./aztec-logs.sh
   ```
...
[One-click RPC setup script](https://github.com/Sshadow84/sepolia-auto-install "Quickly set up a Sepolia node for RPC")
